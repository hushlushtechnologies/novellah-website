...
const features = [
  {
    icon: "/images/icons/modern-beauty.svg",
  ...
  {
    icon: "/images/icons/exceptional-experience.svg",
          ...
          <div className="mt-6 grid grid-cols-1 gap-3 sm:mt-8 sm:grid-cols-3 sm:gap-2">
            {features.map((feature) => (
              <div
                ...
                className={`${cardBaseClasses} flex items-center gap-3 px-3 py-3 text-start sm:flex-col sm:px-2 sm:text-center`}
              >
