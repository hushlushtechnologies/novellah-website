  ...
  return (
    <section className="relative overflow-hidden pb-16 pt-24 lg:pb-0 lg:pt-0" dir="ltr">
      ...
      <div className="relative mx-auto w-full max-w-7xl px-4 sm:px-6 lg:px-8">
        {/* Text + image row — fully contained, no edge bleed */}
        <div className="relative grid w-full items-center gap-10 py-10 lg:grid-cols-2 lg:gap-16 lg:py-16">
          {/* Left: text */}
          ...
          {/* Right: circular image, now a contained grid item instead of edge-bleeding */}
          <div className="relative z-0 mx-auto aspect-square w-full max-w-[320px] sm:max-w-[420px] lg:max-w-[480px] xl:max-w-[560px]">
        ...
        <div className="relative z-20 mt-8 sm:mt-10 lg:-mt-10 xl:-mt-14">
          <div className="grid grid-cols-2 gap-4 rounded-2xl border border-border bg-card p-4 shadow-card sm:grid-cols-4 sm:gap-6 sm:p-6 lg:p-8">
            {stats.map((stat) => (
