        ...
        <div className="mt-12 grid grid-cols-1 gap-6 lg:grid-cols-2">
          ...
          <div className="overflow-hidden rounded-2xl border border-border bg-card">
            <div className="relative h-56 w-full sm:h-64">
              <Image src="/images/philosophy-treatment-room.png" alt="" fill className="object-cover" />
            </div>
            ...
            <div className="p-6">
              ...
              <div className="flex items-center justify-between border-b border-border py-4">
                <p className="font-body text-sm text-foreground">{siteConfig.phone}</p>
              ...
              <div className="flex items-center justify-between border-b border-border py-4">
                <p className="font-body text-sm text-foreground">{siteConfig.email}</p>
              ...
              <div className="mt-3 grid grid-cols-2 gap-4 border-b border-border pb-4">
                <div>
                  <p className="font-body text-sm text-foreground">{siteConfig.hours.weekdays[locale]}</p>
                  <p className="mt-1 font-body text-sm text-muted-foreground">{siteConfig.hours.weekdaysTime}</p>
                </div>
                <div>
                  <p className="font-body text-sm text-foreground">{siteConfig.hours.weekend[locale]}</p>
              ...
              <div className="mt-5 divide-y divide-border rounded-xl border border-border">
                <a href={siteConfig.whatsappHref} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 p-3">
                  ...
                  <span className="flex-1">
                    ...
                    <span className="block font-body text-xs text-muted-foreground">{t("whatsappSubtext")}</span>
                  </span>
                ...
                <a href="/book-appintment" className="flex items-center gap-3 p-3">
                  ...
                  <span className="flex-1">
                    ...
                    <span className="block font-body text-xs text-muted-foreground">{t("consultationSubtext")}</span>
                  </span>
                  <ArrowRight size={14} className="text-primary" />
                </a>
              </div>
