...
const points = [
  ...
  { icon: ShieldCheck, titleKey: "point2Title", descKey: "point2Desc" },
  { icon: Clock, titleKey: "point3Title", descKey: "point3Desc" },
] as const;
        ...
        <div className="grid grid-cols-1 gap-5 rounded-2xl border border-border bg-background-light p-5 shadow-card sm:grid-cols-3 sm:gap-6 sm:p-8">
          {points.map((point) => (
            <div key={point.titleKey} className="flex items-start gap-3">
              ...
              <div>
                <p className="font-heading text-base font-extrabold text-primary">{t(point.titleKey)}</p>
