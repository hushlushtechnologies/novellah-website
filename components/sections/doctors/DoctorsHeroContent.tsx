...
interface DoctorsHeroContentProps {
  eyebrow: string;
...
export function DoctorsHeroContent({
  eyebrow,
  headingLine1Prefix,
      ...
      <div className="mx-auto max-w-[1800px]">
        <div className="grid items-center gap-8 pt-8 sm:pt-10 lg:grid-cols-2 lg:items-start lg:gap-12 lg:pt-0">
          ...
          <motion.div
            ...
            initial="hidden"
            animate="visible"
            className="relative z-10 px-4 pb-4 sm:px-6 sm:pb-6 lg:ps-8 lg:pe-4 lg:pb-20 lg:pt-12 xl:ps-28 xl:pe-6 xl:pb-24 xl:pt-16"
          >
            <motion.p
              variants={revealUp}
              className="font-body text-xs font-semibold uppercase tracking-[0.3em] text-secondary sm:text-sm"
            >
              {eyebrow}
            </motion.p>
            ...
            <motion.h1
              variants={revealUp}
              className="mt-4 font-heading text-3xl leading-tight text-foreground sm:text-4xl lg:text-5xl"
            >
              {headingLine1Prefix} <span className="text-primary">{headingLine1Highlight}</span>
              <br />
              {headingLine2Prefix} <span className="text-primary">{headingLine2Highlight}</span>
            </motion.h1>
          ...
          {points.map((point) => {
            ...
            return (
              <motion.div key={point.title} variants={pointItem} className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-heading text-base text-primary">{point.title}</p>
