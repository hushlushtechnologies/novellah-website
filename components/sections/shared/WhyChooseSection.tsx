...
const features = [
  {
    icon: "/images/icons/expert-certified.svg",
  ...
  {
    icon: "/images/icons/personalized-care-2.svg",
    titleKey: "feature3Title",
    descKey: "feature3Desc",
  },
  {
    icon: "/images/icons/safe-hygienic.svg",
    titleKey: "feature4Title",
    descKey: "feature4Desc",
  },
  {
    icon: "/images/icons/luxury-experience.svg",
    titleKey: "feature5Title",
    descKey: "feature5Desc",
  },
  {
    icon: "/images/icons/proven-results.svg",
        ...
        <div className="mt-12 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => (
            <div
              ...
              className={`flex gap-4  ${cardBaseClasses} p-4`}
            >
