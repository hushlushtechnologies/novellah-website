...
import { ChevronDown, MessageCircle, Phone, CalendarCheck, ShieldCheck, ArrowRight } from "lucide-react";
        ...
        <div className="mt-8 grid grid-cols-1 gap-6 sm:mt-10 lg:grid-cols-[1fr_1.3fr] lg:gap-8">
          ...
          <div className="relative overflow-hidden rounded-2xl bg-background-light p-4 sm:p-5">
            <Image
              ...
              height={340}
              aria-hidden
              className="pointer-events-none absolute -bottom-4 -start-4 -z-0 w-32 opacity-80 sm:w-40"
            />

            <div className="relative z-10 ms-auto max-w-[85%] sm:max-w-[75%]">
              ...
              <p className="mt-1.5 font-body text-sm text-muted-foreground">{t("helpBody")}</p>
              ...
              <div className="mt-3 flex items-center gap-3 bg-card p-3">
                ...
                <div>
                  <p className="font-body text-sm font-semibold text-primary">{t("safetyTitle")}</p>
                  <p className="mt-0.5 font-body text-xs text-muted-foreground">{t("safetyBody")}</p>
                </div>
              </div>
            </div>
          </div>
              ...
              return (
                <div
                  ...
                  className={`rounded-xl border p-4 transition-colors ${
                    isOpen ? "border-transparent bg-background-light" : "border-border bg-card"
                  }`}
                >
                  <button
                  ...
                  >
                    <span
                      className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-full font-body text-xs font-bold ${
                        isOpen ? "bg-primary text-white" : "bg-background-light text-secondary"
                      }`}
                    >
