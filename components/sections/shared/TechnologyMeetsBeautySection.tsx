...
import { cardBaseClasses, sectionDescriptionClasses, sectionDividerClasses, sectionEyebrowClasses, sectionHeadingClasses } from "@/lib/styles";
  ...
  return (
    <section className="relative overflow-hidden py-12 lg:pb-20">
      ...
      <div className="lg:ms-auto lg:max-w-[95%] grid   items-center gap-8 lg:grid-cols-2 lg:gap-12">
        ...
        <div className="px-4 sm:px-6 lg:ps-8 lg:pe-4 xl:ps-16 xl:pe-6">
          ...
          <h2 className={`${sectionHeadingClasses} text-foreground`}>
            <span className="text-primary">
              {t("headingLine1").split(" ")[0]}
            </span>{" "}
            {t("headingLine1").split(" ").slice(1).join(" ")}
            <br />
            <span className="text-primary">
              {t("headingLine2").split(" ")[0]}
            </span>{" "}
        ...
        <div className="relative h-[220px] border-primary/60 sm:h-[300px] lg:h-[420px] xl:h-[460px] lg:rounded-tl-[90px] lg:rounded-bl-[90px] lg:border-l-2 lg:border-t-2 lg:border-b-2 lg:py-4">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mt-10 grid grid-cols-2 gap-4 sm:mt-14 sm:grid-cols-4 sm:gap-6">
          {points.map((point) => (
            <div
              key={point.titleKey}
              className={`${cardBaseClasses} p-5 text-center`}
            >
