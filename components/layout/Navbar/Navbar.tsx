 ...
 className={`flex items-center gap-1 whitespace-nowrap font-body text-sm transition-colors duration-300 ${
  active || megaMenuOpen
    ...
    : "text-foreground group-hover:text-primary"
                    ...
                    {/* <span
                      className={`absolute -bottom-1 start-0   w-full rounded-full bg-primary transition-transform duration-300 ${
                        active || megaMenuOpen ? "scale-x-100" : "scale-x-0 group-hover:scale-x-100"
                      }`}
